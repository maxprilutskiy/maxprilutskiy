export default function Head() {
  return (
    <>
      ...
      {/* Primary Meta Tags */}
      <title>Max Prilutskiy</title>
      <meta name="title" content="Max Prilutskiy" />
      <meta name="description" content="Max Prilutskiy is a product engineer and entrepreneur focused on building products that create a lasting, positive impact. Follow @MaxPrilutskiy on social." />
